...
- Your Docker host is compatible with [Alpine Linux 3.16](https://wiki.alpinelinux.org/wiki/Release_Notes_for_Alpine_3.16.0), which requires Docker 20.10.0 or later
- Your app is compatible with [Ruby 3.1 for Alpine Linux](https://github.com/docker-library/ruby/blob/master/3.1/alpine3.16/Dockerfile)
...
- Your app bundles JavaScript with `rails assets:precompile`. This works with [Webpacker](https://github.com/rails/webpacker), [Asset pipeline (Sprockets)](https://github.com/rails/sprockets-rails) and others.
...
- Based on [ruby:3.1.2-alpine](https://github.com/docker-library/ruby/blob/master/3.1/alpine3.16/Dockerfile)
