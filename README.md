...
- Your app is compatible with [Ruby 3.1 for Alpine Linux](https://github.com/docker-library/ruby/blob/master/3.1/alpine3.15/Dockerfile)
...
- Based on [ruby:3.1.2-alpine](https://github.com/docker-library/ruby/blob/master/3.1/alpine3.15/Dockerfile)
